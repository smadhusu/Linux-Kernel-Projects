/*
 * This program is needs major and minor number to be known before executing.
 * No dynamic allocation of major and minor numbers.
 * The major, minor numbers are specified in call to MKDEV macro.
*/
